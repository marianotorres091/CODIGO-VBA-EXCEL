            ...
            If Not resultado Is Nothing Then
                ...
                Do
                    If wsContenido.Cells(j, 5).Value = tempAnio And wsContenido.Cells(j, 6).Value = tempMes Then
                        bandera = False
                        'actualizar monto
                        If Cells(i, 13).Value = 2 Then
                            wsContenido.Cells(j, 9).Value = wsContenido.Cells(j, 9).Value - Cells(i, 14).Value
                        Else
                            wsContenido.Cells(j, 9).Value = wsContenido.Cells(j, 9).Value + Cells(i, 14).Value
                        End If
                        wsContenido.Cells(j, 10).Value = wsContenido.Cells(j, 10).Value + 1
                        wsContenido.Cells(j, 11).Value = wsContenido.Cells(j, 11).Value & " + " & Cells(i, 5).Value
                    End If
                    j = j + 1
                Loop While valorDoc = wsContenido.Cells(j, 2).Value And bandera
                ...
                If bandera Then
                    ...
                    If bandera2 Then
                        'agregar
                        nFilasCont = nFilasCont + 1
                        wsContenido.Cells(nFilasCont, 1).Value = Cells(i, 5).Value
                        wsContenido.Cells(nFilasCont, 2).Value = valorDoc
                        wsContenido.Cells(nFilasCont, 3).Value = Cells(i, 10).Value
                        wsContenido.Cells(nFilasCont, 4).Value = Cells(i, 16).Value
                        wsContenido.Cells(nFilasCont, 5).Value = tempAnio
                        wsContenido.Cells(nFilasCont, 6).Value = tempMes
                        wsContenido.Cells(nFilasCont, 7).Value = Cells(i, 1).Value
                        wsContenido.Cells(nFilasCont, 8).Value = Cells(i, 2).Value
                        If Cells(i, 13).Value = 2 Then
                            wsContenido.Cells(nFilasCont, 9).Value = Cells(i, 14).Value * (-1)
                        Else
                            wsContenido.Cells(nFilasCont, 9).Value = Cells(i, 14).Value
                        End If
                        wsContenido.Cells(nFilasCont, 10).Value = 1
                    End If
                End If
...
Sub Calcular_Pagos_Rest()
    ...
    'Calcular el número de filas de la hoja Resultado
    Set rangoCont = wsResultado.UsedRange
    nFilasResultado = rangoCont.Rows.Count
        ...
        If Cells(i, 12).Value <> "" Then
            ...
            If wsContenido.Cells(j, 1).Value = Cells(i, 4).Value Then
                ...
                Do
                    ...
                    End If
                    j = j + 1
                Loop While wsContenido.Cells(j, 1).Value = Cells(i, 4).Value
